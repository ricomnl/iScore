...
class iscore(object):
    def __init__(
        self,
        graphrank_out="GraphRank.dat",
        energy_out="Energy.dat",
        weights=[-0.941, 0.041, 0.217, 0.032],
        normalize_graph_rank=True,
    ):
    ...
    def check_mol_features(self):
        ...
        for mol in mols:
            ...
            if mol_feat != features:
                ...
                warnings.warn(
                    f"Molecule {mol} is deleted from scoring due to lacking enough features"
                )
    ...
    def score(self):
        ...
        for mol, feat in self.features.items():
            ...
            if all(k in feat for k in ["grank", "evdw", "ec", "edesolv"]):
                ...
                self.features[mol]["iscore"] = self._scoring_function(
                    data, self.weights
                )
            else:
    ...
    def print(self):
        ...
        if self.normalize_graph_rank:
            ...
            f.write(
                "{:10} {:>14}     {:>14}     {:>14}     {:>14}     {:>14}\n".format(
                    "#Name", "GraphRank", "nEVDW", "nEC", "nEDESOLV", "iScore"
                )
            )
