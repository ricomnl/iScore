...
class iscore_energy(object):
    ...
    def get_energies(self):
        ...
        filenames = list(
            filter(lambda x: x.endswith(".pdb"), os.listdir(self.pdb_path))
        )
    ...
    def print(self):
        ...
        f.write(
            "{:10} {:>14}     {:>14}     {:>14}\n".format(
                "#Name", "nEVDW", "nEC", "nEDESOLV"
            )
        )
        for name, evdw, ec, edesol in zip(
            self.mol_name, self.evdw, self.ec, self.edesolv
        ):
